...
public class AttentionAdapter extends RecyclerView.Adapter<AttentionAdapter.ViewHolder> {
    ...
    public AttentionAdapter(Context context, ArrayList<String> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_attention,viewGroup,false);
