...
import com.example.administrator.whereareyounow.adapter.HometimeAdapter;
...
public class HomeTimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_home_time, container, false);
        //初始化数据
        list = new ArrayList<>();
        initDatas();
        rcv = (RecyclerView) view.findViewById(R.id.rcv);
        initView();
        adapter = new HometimeAdapter(getContext(), list);
